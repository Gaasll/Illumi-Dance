...
.led {
  ...
  transform: translateZ(10px) rotateY(-20deg) rotateX(20deg);
...
@keyframes rotate {
   from { transform: rotateY(50deg) rotateX(-90deg) rotateZ(-30deg)rotateY(50deg) rotateX(-90deg) rotateZ(-30deg); }
